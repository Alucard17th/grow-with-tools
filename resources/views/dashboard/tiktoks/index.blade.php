  ...
  <div class="card">
    ...
    <div class="table-responsive">
      <table class="table mb-0 align-middle">
        <thead>
          <tr>
            <th>#</th><th>Product</th><th>Caption</th><th>Publish At</th><th>Status</th><th>Actions</th>
          </tr>
        </thead>
        <tbody>
          @forelse($posts as $p)
            <tr>
              ...
              <td>{{ optional($p->publish_at)->setTimezone(config('app.timezone'))->format('Y-m-d H:i') }}</td>
              <td>
              ...
              <td>
                <div class="d-flex align-items-center gap-1">
                  ...
                  <a href="{{ route('posts.edit', $p) }}" class="btn btn-sm btn-outline-secondary">Edit</a>
          ...
          @empty
            <tr><td colspan="6" class="text-center py-4">No posts yet.</td></tr>
          @endforelse
        </tbody>
      </table>
    </div>
