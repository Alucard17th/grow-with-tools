<section class="py-4 border-bottom bg-white">
    <div class="container text-center">
        <div class="row g-2 align-items-center justify-content-center opacity-75">
            <div class="col"><img src="{{ asset('img/techs/laravel.svg') }}" alt="Laravel" height="42"></div>
            <div class="col"><img src="{{ asset('img/techs/php.svg') }}" alt="PHP" height="42"></div>
